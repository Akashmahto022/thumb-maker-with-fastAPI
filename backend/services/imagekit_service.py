...
from config import IMAGEKIT_PUBLIC_KEY, IMAGEKIT_PRIVATE_KEY
...
def get_variants(base_url: str) -> dict:
    """Return 3 size variant URLs using imagekit transformations."""
    return{
        "youtube": f"{base_url}?tr=w-1280,h-720,c-maintain_ratio,fo-auto",
        "youtube": f"{base_url}?tr=w-1080,h-1920,c-maintain_ratio,fo-auto",
        "youtube": f"{base_url}?tr=w-1080,h-1080,c-maintain_ratio,fo-auto"
    }
